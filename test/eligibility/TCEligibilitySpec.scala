...
class TCEligibilitySpec extends UnitSpec with FakeCCEligibilityApplication with org.scalatest.PrivateMethodTester with MockitoSugar {
  ...
  "TCEligibilityService" should {
    ...
    "populate the claimant's elements model for a period (1 claimant, non-disabled, non - qualifying)" in {
      ...
      val claimant = Claimant(liveOrWork = false, isPartner = false, hours = 16, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = false, severelyDisabled = false), schemesClaiming = SchemesClaiming())
    ...
    "populate the claimant's elements model for a period (1 claimant, non-disabled, qualifying)" in {
      ...
      val claimant = Claimant(liveOrWork = true, isPartner = false, hours = 16, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = false, severelyDisabled = false), schemesClaiming = SchemesClaiming())
      val ty = TaxYear(from = periodStartDate, until = periodStartDate, claimants = List(claimant), children = List())
    ...
    "populate the claimant's elements model for a period (1 claimant, disabled, working > 16h, qualifying)" in {
      ...
      val claimant = Claimant(liveOrWork = true, isPartner = false, hours = 17, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = false), schemesClaiming = SchemesClaiming())
      val ty = TaxYear(from = periodStartDate, until = periodStartDate, claimants = List(claimant), children = List())
    ...
    "populate the claimant's elements model for a period (1 claimant, disabled, working < 16h, qualifying)" in {
      ...
      val claimant = Claimant(liveOrWork = true, isPartner = false, hours = 14, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = false), schemesClaiming = SchemesClaiming())
    ...
    "populate the claimant's elements model for a period (1 claimant, severely disabled, working < 16h, qualifying)" in {
      ...
      val claimant = Claimant(liveOrWork = true, isPartner = false, hours = 14, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
    ...
    "populate the claimant's elements model for a period (1 claimant, severely disabled, working > 16h, qualifying)" in {
      ...
      val claimant = Claimant(liveOrWork = true, isPartner = false, hours = 16, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
    ...
    "populate the claimant's elements model for a period (couple, 1 non-disabled, 2nd disabled, qualifying)" in {
      ...
      val claimant = Claimant(liveOrWork = true, isPartner = false, hours = 14, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = false, severelyDisabled = false), schemesClaiming = SchemesClaiming())
      val claimant1 = Claimant(liveOrWork = true, isPartner = true, hours = 20, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = false), schemesClaiming = SchemesClaiming())
    ...
    "populate the claimant's elements model for a period (couple, 1 non-disabled > 16h, 2nd severely disabled <16h, qualifying)" in {
      ...
      val claimant = Claimant(liveOrWork = true, isPartner = false, hours = 16, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = false, severelyDisabled = false), schemesClaiming = SchemesClaiming())
      val claimant1 = Claimant(liveOrWork = true, isPartner = true, hours = 0, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
    ...
    "populate the claimant's elements model for a period (couple, 1 severely disabled, 2nd non-disabled, qualifying)" in {
      ...
      val claimant = Claimant(liveOrWork = true, isPartner = false, hours = 16, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = false, severelyDisabled = false), schemesClaiming = SchemesClaiming())
      val claimant1 = Claimant(liveOrWork = true, isPartner = true, hours = 10, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
    ...
    "populate the claimant's elements model for a period (couple, both severely disabled, one working < 16, other > 16, qualifying)" in {
      ...
      val claimant = Claimant(liveOrWork = true, isPartner = false, hours = 2, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
      val claimant1 = Claimant(liveOrWork = true, isPartner = true, hours = 16, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
    ...
    "populate the claimant's elements model for a period (couple, 1 severely disabled, 2nd non-disabled, non-qualifying)" in {
      ...
      val claimant = Claimant(liveOrWork = true, isPartner = false, hours = 16, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = false, severelyDisabled = false), schemesClaiming = SchemesClaiming())
      val claimant1 = Claimant(liveOrWork = false, isPartner = true, hours = 16, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
    ...
    "populate the household elements model for a period (single claimant, 1 qualifying child, working 30h, non-disabled)" in {
      ...
      val child1 = Child(id = 0, name = Some("Child 1"), childcareCost = BigDecimal(200.00), childcareCostPeriod = Periods.Monthly, dob = dateOfBirth1, disability = Disability(disabled = false, severelyDisabled = false), education = None)
      val claimant1 = Claimant(liveOrWork = true, isPartner = false, hours = 30, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = false, severelyDisabled = false), schemesClaiming = SchemesClaiming())
    ...
    "populate the household elements model for a period (single claimant, 1 qualifying child, working 16h, disabled)" in {
      ...
      val child1 = Child(id = 0, name = Some("Child 1"), childcareCost = BigDecimal(200.00), childcareCostPeriod = Periods.Monthly, dob = dateOfBirth1, disability = Disability(disabled = false, severelyDisabled = false), education = None)
      val claimant1 = Claimant(liveOrWork = true, isPartner = false, hours = 16, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = false), schemesClaiming = SchemesClaiming())
      val ty = models.input.tc.TaxYear(from = periodStartDate, until = periodEndDate, claimants = List(claimant1), children = List(child1))
    ...
    "populate the household elements model for a period (single claimant, 1 qualifying child, working 1h, severely disabled)" in {
      ...
      val child1 = Child(id = 0, name = Some("Child 1"), childcareCost = BigDecimal(200.00), childcareCostPeriod = Periods.Monthly, dob = dateOfBirth1, disability = Disability(disabled = false, severelyDisabled = false), education = None)
      val claimant1 = Claimant(liveOrWork = true, isPartner = false, hours = 1, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
      val ty = models.input.tc.TaxYear(from = periodStartDate, until = periodEndDate, claimants = List(claimant1), children = List(child1))
    ...
    "populate the household elements model for a period (single claimant, 1 qualifying young adult (< 19), working 16h, non disabled)" in {
      ...
      val claimant1 = Claimant(liveOrWork = true, isPartner = false, hours = 16, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = false, severelyDisabled = false), schemesClaiming = SchemesClaiming())
      val ty = models.input.tc.TaxYear(from = periodStartDate, until = periodEndDate, claimants = List(claimant1), children = List(child1))
    ...
    "populate the household elements model for a period (single claimant, 1 non qualifying child (> 16), working 16h, severely disabled)" in {
      ...
      val child1 = Child(id = 0, name = Some("Child 1"), childcareCost = BigDecimal(200.00), childcareCostPeriod = Periods.Monthly, dob = dateOfBirth1, disability = Disability(disabled = false, severelyDisabled = false), education = None)
      val claimant1 = Claimant(liveOrWork = true, isPartner = false, hours = 16, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
      val ty = models.input.tc.TaxYear(from = periodStartDate, until = periodEndDate, claimants = List(claimant1), children = List(child1))
    ...
    "populate the household elements model for a period (couple, 1st claimant > 16h, non disabled, 2nd claimant 16h, non disabled, 1 qualifying child)" in {
      ...
      val child1 = Child(id = 0, name = Some("Child 1"), childcareCost = BigDecimal(200.00), childcareCostPeriod = Periods.Monthly, dob = dateOfBirth1, disability = Disability(disabled = false, severelyDisabled = false), education = None)
      val claimant1 = Claimant(liveOrWork = true, isPartner = false, hours = 16, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = false, severelyDisabled = false), schemesClaiming = SchemesClaiming())
      val claimant2 = Claimant(liveOrWork = true, isPartner = true, hours = 16, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = false, severelyDisabled = false), schemesClaiming = SchemesClaiming())
      val ty = models.input.tc.TaxYear(from = periodStartDate, until = periodEndDate, claimants = List(claimant1, claimant2), children = List(child1))
    ...
    "populate the household elements model for a period (couple, 1st claimant > 16h, non disabled, 2nd claimant 0h incapacitated, 1 qualifying child)" in {
      ...
      val child1 = Child(id = 0, name = Some("Child 1"), childcareCost = BigDecimal(200.00), childcareCostPeriod = Periods.Monthly, dob = dateOfBirth1, disability = Disability(disabled = false, severelyDisabled = false), education = None)
      val claimant1 = Claimant(liveOrWork = true, isPartner = false, hours = 16, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = false, severelyDisabled = false), schemesClaiming = SchemesClaiming())
      val claimant2 = Claimant(liveOrWork = true, isPartner = true, hours = 0, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true, incapacitated = true), schemesClaiming = SchemesClaiming())
      val ty = models.input.tc.TaxYear(from = periodStartDate, until = periodEndDate, claimants = List(claimant1, claimant2), children = List(child1))
    ...
    "populate the household elements model for a period (couple, 1st claimant 0h, non disabled, 2nd claimant 0h severely disabled, 1 qualifying child)" in {
      ...
      val child1 = Child(id = 0, name = Some("Child 1"), childcareCost = BigDecimal(200.00), childcareCostPeriod = Periods.Monthly, dob = dateOfBirth1, disability = Disability(disabled = false, severelyDisabled = false), education = None)
      val claimant1 = Claimant(liveOrWork = true, isPartner = false, hours = 0, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = false, severelyDisabled = false), schemesClaiming = SchemesClaiming())
      val claimant2 = Claimant(liveOrWork = true, isPartner = true, hours = 0, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
      val ty = models.input.tc.TaxYear(from = periodStartDate, until = periodEndDate, claimants = List(claimant1, claimant2), children = List(child1))
    ...
    "determine if the household is eligible for the Tax Credits (single claimant - lives and works in UK)" in {
      ...
      val claimant1 = Claimant(liveOrWork = true, isPartner = false, hours = 0, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
    ...
    "determine if the household is eligible for the Tax Credits (single claimant - doesn't live and work in UK)" in {
      ...
      val claimant1 = Claimant(liveOrWork = false, isPartner = false, hours = 0, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
      val ty = models.input.tc.TaxYear(from = periodStartDate, until = periodEndDate, claimants = List(claimant1), children = List())
    ...
    "determine if the household is eligible for the Tax Credits (single claimant - lives and works in UK in first ty, doesn't in the second)" in {
      ...
      val claimant1 = Claimant(liveOrWork = true, isPartner = false, hours = 0, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
      val claimant2ndTY = Claimant(liveOrWork = false, isPartner = false, hours = 0, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
    ...
    "determine if the household is eligible for the Tax Credits (couple - both don't live or work in UK)" in {
      ...
      val claimant1 = Claimant(liveOrWork = false, isPartner = false, hours = 0, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
      val claimant2 = Claimant(liveOrWork = false, isPartner = true, hours = 0, totalIncome = 0.00, previousTotalIncome = 0.00, disability = Disability(disabled = true, severelyDisabled = true), schemesClaiming = SchemesClaiming())
      val ty = models.input.tc.TaxYear(from = periodStartDate, until = periodEndDate, claimants = List(claimant1, claimant2), children = List())
    ...
    "calculate and populate TC Eligibility model (one tax year, one period)" in {
      ...
      val child1 = Child(id = 0, name = Some("Child 1"), childcareCost = BigDecimal(200.00), childcareCostPeriod = Periods.Monthly, dob = dateOfBirth1, disability = Disability(disabled = false, severelyDisabled = false), education = None)
      val claimant1 = Claimant(liveOrWork = true, isPartner = false, hours = 16, totalIncome = 26000.00, previousTotalIncome = 20010.00, disability = Disability(disabled = false, severelyDisabled = false), schemesClaiming = SchemesClaiming())
      val ty = models.input.tc.TaxYear(from = periodStartDate, until = periodEndDate, claimants = List(claimant1), children = List(child1))
