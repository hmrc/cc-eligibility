    ...
    "convert Household to TFC Eligibility Input" when {
      "a household with parent, no partner and 2 children" in {
        ...
        val expectedOutput = TFCEligibilityInput(currentDate, 4, "england",
          List(TFCClaimant(None, Some(TFCIncome(Some(25000), Some(1200), Some(6000))),false, TFCDisability(false, false), false,
      ...
      "a household with parent, partner and 2 children" in {
        ...
        val expectedOutput = TFCEligibilityInput(currentDate, 4, "england",
          List(TFCClaimant(None, Some(TFCIncome(Some(12212), Some(47674), Some(647864))),  false, TFCDisability(false, false), false,
            ...
            TFCClaimant(None, Some(TFCIncome(Some(12212), Some(47674), Some(647864))),  true, TFCDisability(false, false), false,
