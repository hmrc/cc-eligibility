    ...
    "Child" should {
      ...
      "determine childs Birthday(11th or 16th) where child is not disable" in {
        ...
        val child = new TFCChild(
          ...
          dob = dateOfBirth,
          disability = TFCDisability()) { override lazy val tFCConfig: TFCConfig = tfcConfig }
      ...
      "determine childs Birthday (11th or 16th) where child is disabled" in {
        ...
        val child = new TFCChild(
          ...
          childcareCostPeriod = Periods.Monthly,
          dob = dateOfBirth,
          disability = TFCDisability(disabled = true)) { override lazy val tFCConfig: TFCConfig = tfcConfig }
        val child11Birthday = child.getChildBirthday(current, "england")
